...
void kr_effects_set_sample_rate(kr_effects_t *kr_effects,
 uint32_t sample_rate);
void kr_effects_process(kr_effects_t *kr_effects, float **input,
 float **output, int num_samples);

/* OpControls */
void kr_effects_effect_add2(kr_effects_t *kr_effects, kr_effect_type_t effect,
 krad_mixer_t *krad_mixer, char *portgroupname);
