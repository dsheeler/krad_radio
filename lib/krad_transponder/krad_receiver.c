...
static void *krad_receiver_thread (void *arg);
static void krad_receiver_destroy_client (krad_receiver_client_t *krad_receiver_client);
static void krad_receiver_create_client (krad_receiver_t *krad_receiver, int sd);
static void *krad_receiver_client_thread (void *arg);
static void krad_receiver_promote_client (krad_receiver_client_t *client);
