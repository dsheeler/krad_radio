...
krad_mixer_portgroup_t *krad_mixer_local_portgroup_create(krad_mixer_t *mixer,
 char *sysname, int direction, int shm_sd, int msg_sd);
krad_mixer_portgroup_t *krad_mixer_portgroup_create(krad_mixer_t *krad_mixer,
...
void krad_mixer_portgroup_mixmap_channel(krad_mixer_portgroup_t *portgroup,
