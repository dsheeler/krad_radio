...
int kr_ebml2_pack_header(kr_ebml *e, char *doctype, uint32_t ver, uint32_t read_version);
...
int kr_ebml2_pack_data(kr_ebml *e, uint32_t element, void *data, uint64_t len);
...
int kr_ebml2_pack_int64(kr_ebml *kr_ebml, uint32_t element, int64_t number);
int kr_ebml2_pack_uint64(kr_ebml *kr_ebml, uint32_t element, uint64_t number);
