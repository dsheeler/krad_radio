...
typedef enum {
  ...
  TEXT_KRAD_LINK_VIDEO_SOURCE_T,
  TEXT_KRAD_TRANSPONDER_REP_ST,
  TEXT_KR_FLAC_ENCODER_ST,
  TEXT_KR_VPX_DECODER_ST,
  TEXT_KR_THEORA_DECODER_ST,
  TEXT_KR_DAALA_DECODER_ST,
  TEXT_KR_VORBIS_DECODER_ST,
  TEXT_KR_OPUS_DECODER_ST,
  TEXT_KR_FLAC_DECODER_ST,
  TEXT_KR_VPX_ENCODER_ST,
  TEXT_KR_THEORA_ENCODER_ST,
  TEXT_KR_DAALA_ENCODER_ST,
  TEXT_KR_VORBIS_ENCODER_ST,
  TEXT_KR_OPUS_ENCODER_ST,
  TEXT_KR_AUDIO_CODEC_T,
  TEXT_KR_VIDEO_CODEC_T,
  TEXT_KR_AUDIO_ENCODER_ST,
  TEXT_KR_VIDEO_DECODER_ST,
  TEXT_KR_AUDIO_DECODER_ST,
  TEXT_KR_VIDEO_ENCODER_ST,
  TEXT_KR_AV_ENCODER_T,
  TEXT_KR_ENCODER_ST,
  TEXT_KR_AV_DECODER_T,
  TEXT_KR_UDP_MUXER_ST,
  TEXT_KR_OGG_MUXER_ST,
  TEXT_KR_MKV_MUXER_ST,
  TEXT_KR_TRANSOGG_MUXER_ST,
  TEXT_KR_UDP_DEMUXER_ST,
  TEXT_KR_OGG_DEMUXER_ST,
  TEXT_KR_MKV_DEMUXER_ST,
  TEXT_KR_TRANSOGG_DEMUXER_ST,
  TEXT_KR_MUXER_ACTUAL_T,
  TEXT_KR_MUXER_ST,
  TEXT_KR_DEMUXER_ACTUAL_T,
  TEXT_KR_RAWIN_ST,
  TEXT_KR_RAWOUT_ST,
  TEXT_KR_TRANSPONDER_SUBUNIT_ACTUAL_T,
  TEXT_KRAD_TRANSPONDER_SUBUNIT_REP_ST,
...
typedef enum {
  ...
  JSON_KRAD_LINK_VIDEO_SOURCE_T,
  JSON_KRAD_TRANSPONDER_REP_ST,
  JSON_KR_FLAC_ENCODER_ST,
  JSON_KR_VPX_DECODER_ST,
  JSON_KR_THEORA_DECODER_ST,
  JSON_KR_DAALA_DECODER_ST,
  JSON_KR_VORBIS_DECODER_ST,
  JSON_KR_OPUS_DECODER_ST,
  JSON_KR_FLAC_DECODER_ST,
  JSON_KR_VPX_ENCODER_ST,
  JSON_KR_THEORA_ENCODER_ST,
  JSON_KR_DAALA_ENCODER_ST,
  JSON_KR_VORBIS_ENCODER_ST,
  JSON_KR_OPUS_ENCODER_ST,
  JSON_KR_AUDIO_CODEC_T,
  JSON_KR_VIDEO_CODEC_T,
  JSON_KR_AUDIO_ENCODER_ST,
  JSON_KR_VIDEO_DECODER_ST,
  JSON_KR_AUDIO_DECODER_ST,
  JSON_KR_VIDEO_ENCODER_ST,
  JSON_KR_AV_ENCODER_T,
  JSON_KR_ENCODER_ST,
  JSON_KR_AV_DECODER_T,
  JSON_KR_UDP_MUXER_ST,
  JSON_KR_OGG_MUXER_ST,
  JSON_KR_MKV_MUXER_ST,
  JSON_KR_TRANSOGG_MUXER_ST,
  JSON_KR_UDP_DEMUXER_ST,
  JSON_KR_OGG_DEMUXER_ST,
  JSON_KR_MKV_DEMUXER_ST,
  JSON_KR_TRANSOGG_DEMUXER_ST,
  JSON_KR_MUXER_ACTUAL_T,
  JSON_KR_MUXER_ST,
  JSON_KR_DEMUXER_ACTUAL_T,
  JSON_KR_RAWIN_ST,
  JSON_KR_RAWOUT_ST,
  JSON_KR_TRANSPONDER_SUBUNIT_ACTUAL_T,
  JSON_KRAD_TRANSPONDER_SUBUNIT_REP_ST,
...
typedef enum {
  ...
  EBML_KRAD_LINK_VIDEO_SOURCE_T,
  EBML_KRAD_TRANSPONDER_REP_ST,
  EBML_KR_FLAC_ENCODER_ST,
  EBML_KR_VPX_DECODER_ST,
  EBML_KR_THEORA_DECODER_ST,
  EBML_KR_DAALA_DECODER_ST,
  EBML_KR_VORBIS_DECODER_ST,
  EBML_KR_OPUS_DECODER_ST,
  EBML_KR_FLAC_DECODER_ST,
  EBML_KR_VPX_ENCODER_ST,
  EBML_KR_THEORA_ENCODER_ST,
  EBML_KR_DAALA_ENCODER_ST,
  EBML_KR_VORBIS_ENCODER_ST,
  EBML_KR_OPUS_ENCODER_ST,
  EBML_KR_AUDIO_CODEC_T,
  EBML_KR_VIDEO_CODEC_T,
  EBML_KR_AUDIO_ENCODER_ST,
  EBML_KR_VIDEO_DECODER_ST,
  EBML_KR_AUDIO_DECODER_ST,
  EBML_KR_VIDEO_ENCODER_ST,
  EBML_KR_AV_ENCODER_T,
  EBML_KR_ENCODER_ST,
  EBML_KR_AV_DECODER_T,
  EBML_KR_UDP_MUXER_ST,
  EBML_KR_OGG_MUXER_ST,
  EBML_KR_MKV_MUXER_ST,
  EBML_KR_TRANSOGG_MUXER_ST,
  EBML_KR_UDP_DEMUXER_ST,
  EBML_KR_OGG_DEMUXER_ST,
  EBML_KR_MKV_DEMUXER_ST,
  EBML_KR_TRANSOGG_DEMUXER_ST,
  EBML_KR_MUXER_ACTUAL_T,
  EBML_KR_MUXER_ST,
  EBML_KR_DEMUXER_ACTUAL_T,
  EBML_KR_RAWIN_ST,
  EBML_KR_RAWOUT_ST,
  EBML_KR_TRANSPONDER_SUBUNIT_ACTUAL_T,
  EBML_KRAD_TRANSPONDER_SUBUNIT_REP_ST,
...
typedef enum {
  ...
  DEBML_KRAD_LINK_VIDEO_SOURCE_T,
  DEBML_KRAD_TRANSPONDER_REP_ST,
  DEBML_KR_FLAC_ENCODER_ST,
  DEBML_KR_VPX_DECODER_ST,
  DEBML_KR_THEORA_DECODER_ST,
  DEBML_KR_DAALA_DECODER_ST,
  DEBML_KR_VORBIS_DECODER_ST,
  DEBML_KR_OPUS_DECODER_ST,
  DEBML_KR_FLAC_DECODER_ST,
  DEBML_KR_VPX_ENCODER_ST,
  DEBML_KR_THEORA_ENCODER_ST,
  DEBML_KR_DAALA_ENCODER_ST,
  DEBML_KR_VORBIS_ENCODER_ST,
  DEBML_KR_OPUS_ENCODER_ST,
  DEBML_KR_AUDIO_CODEC_T,
  DEBML_KR_VIDEO_CODEC_T,
  DEBML_KR_AUDIO_ENCODER_ST,
  DEBML_KR_VIDEO_DECODER_ST,
  DEBML_KR_AUDIO_DECODER_ST,
  DEBML_KR_VIDEO_ENCODER_ST,
  DEBML_KR_AV_ENCODER_T,
  DEBML_KR_ENCODER_ST,
  DEBML_KR_AV_DECODER_T,
  DEBML_KR_UDP_MUXER_ST,
  DEBML_KR_OGG_MUXER_ST,
  DEBML_KR_MKV_MUXER_ST,
  DEBML_KR_TRANSOGG_MUXER_ST,
  DEBML_KR_UDP_DEMUXER_ST,
  DEBML_KR_OGG_DEMUXER_ST,
  DEBML_KR_MKV_DEMUXER_ST,
  DEBML_KR_TRANSOGG_DEMUXER_ST,
  DEBML_KR_MUXER_ACTUAL_T,
  DEBML_KR_MUXER_ST,
  DEBML_KR_DEMUXER_ACTUAL_T,
  DEBML_KR_RAWIN_ST,
  DEBML_KR_RAWOUT_ST,
  DEBML_KR_TRANSPONDER_SUBUNIT_ACTUAL_T,
  DEBML_KRAD_TRANSPONDER_SUBUNIT_REP_ST,
...
typedef enum {
  ...
  HELPERS_KRAD_LINK_VIDEO_SOURCE_T,
  HELPERS_KRAD_TRANSPONDER_REP_ST,
  HELPERS_KR_FLAC_ENCODER_ST,
  HELPERS_KR_VPX_DECODER_ST,
  HELPERS_KR_THEORA_DECODER_ST,
  HELPERS_KR_DAALA_DECODER_ST,
  HELPERS_KR_VORBIS_DECODER_ST,
  HELPERS_KR_OPUS_DECODER_ST,
  HELPERS_KR_FLAC_DECODER_ST,
  HELPERS_KR_VPX_ENCODER_ST,
  HELPERS_KR_THEORA_ENCODER_ST,
  HELPERS_KR_DAALA_ENCODER_ST,
  HELPERS_KR_VORBIS_ENCODER_ST,
  HELPERS_KR_OPUS_ENCODER_ST,
  HELPERS_KR_AUDIO_CODEC_T,
  HELPERS_KR_VIDEO_CODEC_T,
  HELPERS_KR_AUDIO_ENCODER_ST,
  HELPERS_KR_VIDEO_DECODER_ST,
  HELPERS_KR_AUDIO_DECODER_ST,
  HELPERS_KR_VIDEO_ENCODER_ST,
  HELPERS_KR_AV_ENCODER_T,
  HELPERS_KR_ENCODER_ST,
  HELPERS_KR_AV_DECODER_T,
  HELPERS_KR_UDP_MUXER_ST,
  HELPERS_KR_OGG_MUXER_ST,
  HELPERS_KR_MKV_MUXER_ST,
  HELPERS_KR_TRANSOGG_MUXER_ST,
  HELPERS_KR_UDP_DEMUXER_ST,
  HELPERS_KR_OGG_DEMUXER_ST,
  HELPERS_KR_MKV_DEMUXER_ST,
  HELPERS_KR_TRANSOGG_DEMUXER_ST,
  HELPERS_KR_MUXER_ACTUAL_T,
  HELPERS_KR_MUXER_ST,
  HELPERS_KR_DEMUXER_ACTUAL_T,
  HELPERS_KR_RAWIN_ST,
  HELPERS_KR_RAWOUT_ST,
  HELPERS_KR_TRANSPONDER_SUBUNIT_ACTUAL_T,
  HELPERS_KRAD_TRANSPONDER_SUBUNIT_REP_ST,
