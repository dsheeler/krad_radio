...
function CanvasState(canvas, ghostcanvas) {
    ...
    canvas.addEventListener('mousemove', function(e) {
	      if (myState.dragging){
            ...
            //mx = Math.cos(myState.selection.r) * mouse.x + Math.sin(myState.selection.r) * mouse.y;
            //my = -Math.sin(myState.selection.r) * mouse.x + Math.cos(myState.selection.r) * mouse.y;
            ...
            myState.selection.PCView.handles[myState.expectMovePerspectiveCorrectionHandle].x =  (mx - selx)/myState.selection.xs;
            myState.selection.PCView.handles[myState.expectMovePerspectiveCorrectionHandle].y =  (my - sely)/myState.selection.ys;
            kradwebsocket.debug(myState.selection.PCView.handles[myState.expectMovePerspectiveCorrectionHandle].x + " " +             myState.selection.PCView.handles[myState.expectMovePerspectiveCorrectionHandle].y);
...
Kradradio.prototype.comp_ctrl = function (num, type, control_name, value) {
  kradradio.ctrl(type + "/" + num + "/" + control_name, value);
}

Kradradio.prototype.ctrl = function(path, val) {

  var cmd = '{"ctrl":"' + path + ' ' + val + ' ' + '0' + '"}';
