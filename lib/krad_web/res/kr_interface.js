...
Kr.prototype.update_subunit = function(num, type, control_name, value) {
  ...
  switch (control_name) {
    ...
    case "opacity":
      ...
      break;
     case "xscale":
      $('#' + type_num + '_xs').html(value.toFixed(3));
      break;
     case "yscale":
      $('#' + type_num + '_ys').html(value.toFixed(3));
      break;
...
Kr.prototype.got_add_subunit = function (crate) {
  ...
  if ((crate.subunit_type != 'videoport') || (crate.direction != 'output')) {
    ...
    $('#subunit_list').append("<li class=subunit id='" + type_num + "'>" + type_num + "</li>");
     if (crate.subunit_type == "sprite") {
       $('#' + type_num).append(" filename: <div style='display: inline' id='" + type_num 
        + "_filename'>" + crate.filename+ "</div>");
     }
     ...
     $("#" + type_num).append(
      ...
      + " opacity: <div style='display: inline' id='" + type_num + "_o'>" + crate.o.toFixed(3) + "</div>" 
      + " scalex: <div style='display: inline' id='" + type_num + "_xs'>" + crate.xscale.toFixed(3) + "</div>" 
      + " scaley: <div style='display: inline' id='" + type_num + "_ys'>" + crate.yscale.toFixed(3) + "</div>");
...
Kr.prototype.got_add_portgroup = function(crate) {
  ...
  volume_div = "<div class='kradmixer_control volume_control' id='portgroup_" 
   ...
   + "<canvas width='24' height='200' class='meter' id='" 
  ...
  if (crate.portgroup_name == "DTMF") {
	  ...
	  $('#stack').append("<div id='" + crate.portgroup_name + "_dtmf_pad' " 
     + "class='kradmixer_control dtmf_pad'>" 
     + "<div class='button_wrap'><div class='krad_button_very_small close'>-</div></div>"
     + "<div id='" + crate.portgroup_name 
     + "_dtmf' style='float: left'>  </div> </div>");
    
    $("#" + crate.portgroup_name + "_dtmf_pad .close").bind('click', function () {
    $('.chooser').append("<div class='chooser_choice' id='"
     ...
     $('#' + crate.portgroup_name + '_dtmf_pad').hide(200);

    $('#' + crate.portgroup_name + '_dtmf_pad_min_choice').bind('click', function() {
      $('#' + crate.portgroup_name + '_dtmf_pad').show(200);
      $(this).remove();
    });
