...
Kradradio.prototype.portgroup_handle_crossfade_group = function(portgroup_name,
 crossfade_name, crossfade) {
  ...
  if (crossfade_name.length > 0) {
     ...
     + portgroup_name + "_crossfade' class='crossfade crossfade_control'><div class='fade'><div class='handle'></div></div><h2>" + portgroup_name
  ...
  this.portgroup_crossfade_sliders[portgroup_name] = new Slider(crossfade_slider, crossfade_slider.getElement('.handle'), {
      range: [-100, 100],
        steps: 201,
        wheel: true,
        mode: "horizontal",
        ...
        onChange: function (value) {
            if (value) kradradio.ctrl("m/" + portgroup_name + "/c", value)
        }
    });
  }
}
...
Kradradio.prototype.got_add_portgroup = function(crate) {
  ...
  volume_div = "<div class='kradmixer_control volume_control' id='portgroup_" 
   ...
   + "<div class='handle'></div></div></div><div class='button_wrap'><div class='krad_button' id='show_effects_"
  ...
  this.portgroup_volume_sliders[name] = new Slider(volume_slider, volume_slider.getElement('.handle'), {
      range: [100, 0],
        steps: 101,
        wheel: true,
        mode: "vertical",
        ...
        onChange: function (value) {
            if (value) kradradio.ctrl("m/" + crate.portgroup_name + "/v", value)
        }
    });
  ...
  if (crate.direction == 1) {
    ...
    this.portgroup_effect_sliders[name] = new Slider(effect_slider, effect_slider.getElement('.handle'), {
      range: [12000, 20],
        ...
        onChange: function (value) {
            if (value) kradradio.ctrl("e/" + crate.portgroup_name + "/lp/hz", value)
        }
    });
    ...
    this.portgroup_effect_sliders[name] = new Slider(effect_slider, effect_slider.getElement('.handle'), {
      range: [5.0, 0.1],
        ...
        onChange: function (value) {
            if (value) kradradio.ctrl("e/" + crate.portgroup_name + "/lp/bw", value)
        }
    });
    ...
    this.portgroup_effect_sliders[name] = new Slider(effect_slider, effect_slider.getElement('.handle'), {
      range: [20000, 20],
        ...
        onChange: function (value) {
            if (value) kradradio.ctrl("e/" + crate.portgroup_name + "/hp/hz", value)
        }
    });
    ...
    this.portgroup_effect_sliders[name] = new Slider(effect_slider, effect_slider.getElement('.handle'), {
      range: [5, 0.1],
        ...
        onChange: function (value) {
            if (value) kradradio.ctrl("e/" + crate.portgroup_name + "/hp/bw", value)
        }
    });
    ...
    this.portgroup_effect_sliders[name] = new Slider(effect_slider, effect_slider.getElement('.handle'), {
      range: [10, 0.1],
        ...
        onChange: function (value) {
            if (value) kradradio.ctrl("e/" + crate.portgroup_name + "/a/drive", value)
        }
    });
    ...
    this.portgroup_effect_sliders[name] = new Slider(effect_slider, effect_slider.getElement('.handle'), {
      range: [10, -10],
        ...
        onChange: function (value) {
            if (value) kradradio.ctrl("e/" + crate.portgroup_name + "/a/blend", value)
        }
    });
	 
	  $('.kradmixer_cappa').append("<br clear='both'/>"
     + " <div id='" + crate.portgroup_name + "_effects_eq' style='float:left'></div>");

    for (var i = 0; i < 32; i++) {
      $('#' + crate.portgroup_name + '_effects_eq').append
       ("<div class='kradmixer_control' id='"
       + crate.portgroup_name + "_eq_" + i + "_hz'><div class='volume'><div class='handle'></div></div></div>");
	
  		var name = crate.portgroup_name + "_eq_" + i + "_hz";
      var eq_element = document.id(name);
      var eq_slider = effect_element.getElement('.volume');
      var mini;
	    var maxi;
      ...
      this.portgroup_eq_sliders[name] = new Slider(eq_slider, eq_slider.getElement('.handle'), {
        range: [maxi, mini],
        steps: 1,
        wheel: true,
        mode: "vertical",
        ...
        onChange: function (value) {
            if (value) kradradio.ctrl("e/" + crate.portgroup_name + "/eq/" + i + "/hz", value)
        }
      });
    }
    ...
    for (var i = 0; i < 32; i++) {
       ...
       + "<div class='handle'></div></div></div>");
  		var name = crate.portgroup_name + "_eq_" + i + "_db";
      var eq_element = document.id(name);
      var eq_slider = effect_element.getElement('.volume');
      ...
      this.portgroup_eq_sliders[name] = new Slider(eq_slider, eq_slider.getElement('.handle'), {
        ...
        onChange: function (value) {
            if (value) kradradio.ctrl("e/" + crate.portgroup_name + "/eq/" + i + "/db", value)
        }
	    });
	  }
      ...
      this.portgroup_eq_sliders[name] = new Slider(eq_slider, eq_slider.getElement('.handle'), {
        ...
        onChange: function (value) {
            if (value) kradradio.ctrl("e/" + crate.portgroup_name + "/eq/" + i + "/bw", value)
        }
	    });
    }
  }
