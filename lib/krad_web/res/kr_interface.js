...
<div id='stack' class='yelleryellow'><button class='close'>&times;</button>\
<div class='chooser'>\
...
<div id='kradmixer' class='ultraviolet kradmixer'>\
<div id='mixers'><div class='analog_meter_wrapper' style='float: left'>\
...
<div id='COMPER' class='chooser_choice'><h2>COMPER</h2>\
  ...
  $("#crossfades .close").bind('click', function () {
    ...
    $("#stack .close").bind('click', function () {
    $('.chooser').append("<div class='chooser_choice' id='stack_min_choice'"
     + "><h3>Xmms2 Controls</h3></div>");
     $('#stack').hide(200);

    $('#stack_min_choice').bind('click', function() {
      $('#stack').show(200);
      $(this).remove();
    });
  });
...
//	  $('#portgroup_' + portgroup_name + '_wrap').after("<div id='portgroup_"
    $('#mixers').append("<div id='portgroup_"
...
Kr.prototype.got_add_subunit = function (crate) {
  ...
  if ((crate.subunit_type != 'videoport') || (crate.direction != 'output')) {
    ...
    $('#subunit_list').append("<li class=subunit id='" + shape.type + '_'
     + shape.num + "'>" + shape.type + "_" + shape.num + " x: " + crate.x + " y: " + crate.y + '</li>');
...
Kr.prototype.got_add_portgroup = function(crate) {
  ...
  if (crate.direction == 1) {
    ...
    $('.kradmixer_cappa').append("<div class='effect_area' "
     ...
     + crate.portgroup_name + "_lowpass_hz'><h4 class='ultraviolet' id='lp_hz_label'>LP FREQ</h4>"
     + "<div class='volume'>"
     + "<div class='handle'></div></div></div>");

	  $('#' + crate.portgroup_name + '_effects').append
     ("<div class='kradmixer_control' id='"
     + crate.portgroup_name + "_lowpass_bw'><h4 class='ultraviolet' id='lp_bw_label'>BANDWIDTH</h4><div class='volume'>"
     + "<div class='handle'></div></div></div>");

	  $('#' + crate.portgroup_name + '_effects').append
     ("<div class='kradmixer_control' id='"
     + crate.portgroup_name + "_highpass_hz'><h4 class='ultraviolet' id='hp_hz_label'>HP FREQ</h4><div class='volume'>"
     + "<div class='handle'></div></div></div>");

	  $('#' + crate.portgroup_name + '_effects').append
     ("<div class='kradmixer_control' id='"
     + crate.portgroup_name + "_highpass_bw'><h4 class='ultraviolet' id='hp_hz_label'>BANDWIDTH</h4><div class='volume'>"
     + "<div class='handle'></div></div></div>");

	  $('#' + crate.portgroup_name + '_effects').append
     ("<div class='kradmixer_control' id='"
     + crate.portgroup_name + "_analog_drive'><h4 class='ultraviolet' id='hp_hz_label'>DRIVE</h4><div class='volume'>"
     + "<div class='handle'></div></div></div>");

	  $('#' + crate.portgroup_name + '_effects').append
     ("<div class='kradmixer_control' id='"
     + crate.portgroup_name + "_analog_blend'><h4  class='ultraviolet'id='hp_hz_label'>BLEND</h4><div class='volume'>"
     + "<div class='handle'></div></div></div>");
