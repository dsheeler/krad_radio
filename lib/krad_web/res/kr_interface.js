...
Kradradio.prototype.load_interface = function() {
   ...
   volume_slider.getElement('.handle'), {
      range: [100, 0],
        ...
        onTick: function(pos){
          ...
          this.element.setStyle('border-width', '20px');
          this.knob.setStyle(this.property, pos);
        },
        onComplete: function(){
          this.element.setStyle('border-color', '#000');
          //this.element.tween('border-color').start('#000');
        },
        address: "m/" + crate.portgroup_name + "/v",
...
*/
  /*
  if (typeof(this.interface_data.slide) === 'undefined') {
    this.interface_data.slide = new Object();
  }
  this.interface_data.slide['show_effects_' + crate.portgroup_name] 
   = new Fx.Slide('show_effects_' + crate.portgroup_name);

  $('#show_effects_' + crate.portgroup_name).addEvent(("click"), function(event) {
    event.stop();
    this.interface_data.slide['show_effects_' + crate.portgroup_name].toggle(); 
  });
*/
