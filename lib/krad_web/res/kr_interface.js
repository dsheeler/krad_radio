...
<div class='kradmixer_cappa'><button class='close'>&times;</button>\
<h2 id='effects_region_description'>Audio Effects</h2></div>\
</div>");
...
<div id='COMPER' class='chooser_choice'><h2>COMPER</h2>\
  ...
  $("#crossfades .close").bind('click', function () {
    $('.chooser').append("<div class='chooser_choice' id='crossfades_min_choice'"
     + "><h3>Crossfades</h3></div>");
     $('#crossfades').hide(200);
    ...
    $('.chooser').append("<div class='chooser_choice' id='xmms2s_min_choice'"
     + "><h3>Xmms2 Controls</h3></div>");
     $('#xmms2s').hide(200);
...
//	  $('#portgroup_' + portgroup_name + '_wrap').after("<div id='portgroup_"
    $('#crossfades').append("<div id='portgroup_"
     ...
     + portgroup_name + "_crossfade' class='crossfade'>"
...
Kr.prototype.got_add_portgroup = function(crate) {
  ...
  $("#portgroup_" + crate.portgroup_name + "_wrap .close").bind('click', function () {
    $('.chooser').append("<div class='chooser_choice' id='portgroup_"
     + crate.portgroup_name + "_min_choice'><h3>"
     + crate.portgroup_name + "</h3></div>");
     $('#portgroup_' + crate.portgroup_name + '_wrap').hide(200);

    $('#portgroup_' + crate.portgroup_name + '_min_choice').bind('click', function() {
      $('#portgroup_' + crate.portgroup_name + '_wrap').show(200);
      $(this).remove();
    });
  ...
  if (crate.portgroup_name == "DTMF") {
	  ...
	  $('#kradmixer').append("<div id='" + crate.portgroup_name + "_dtmf_pad' " 
     + "class='kradmixer_control dtmf_pad'>" 
     + "<button class='close'>&times;</button> <div id='" + crate.portgroup_name 
