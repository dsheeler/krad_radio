...
Kr.prototype.load_interface = function() {
  ...
  this.interface_data.rack_space_px = (screen.width * 0.95) / 16;
...
Kr.prototype.position_RCUs = function() {
  ...
  this.interface_data.grid['width'] = Math.floor(window.innerWidth / this.interface_data.rack_space_px);
  this.interface_data.grid['height'] = Math.floor(window.innerHeight / this.interface_data.rack_space_px);
  ...
  for (var i = 0; i < kr.interface_data.RCUs.length; i++) {
        ...
        var top = kr.interface_data.rack_space_px * kr.interface_data.RCUs[i].y;
        var left = kr.interface_data.rack_space_px * kr.interface_data.RCUs[i].x;
        var height = kr.interface_data.rack_space_px * kr.interface_data.RCUs[i].height;
        var width = kr.interface_data.rack_space_px * kr.interface_data.RCUs[i].width;
