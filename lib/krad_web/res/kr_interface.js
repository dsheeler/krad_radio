...
Kr.prototype.portgroup_handle_xmms2 = function (portgroup_name, xmms2) {
  if (xmms2 == 0) {
    if ($('#' + portgroup_name + '_xmms2_wrap')) {
     ...
     + "_xmms2_wrap' class='xmms2_control'><div id='"
...
Kr.prototype.got_add_portgroup = function(crate) {
  ...
  volume_div = "<div class='kradmixer_control volume_control' id='portgroup_" 
   ...
   + "<canvas width='20' height='200' class='meter' id='" 
  ...
  $('#fx_' + crate.portgroup_name).bind("click",
    function(event, ui) {
      var fx = document.id(crate.portgroup_name + "_effects");
      fx.toggle();
      var eq = document.id("eq_" + crate.portgroup_name);
      eq.toggle();
    }
  );
