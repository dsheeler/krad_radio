...
Kr.prototype.calc_rack = function() {
  ...
  this.interface_data.rack_density = 16;

  var view_width = window.innerWidth;
  var view_height = window.innerHeight;
  var rack_space_sz = view_width / this.interface_data.rack_density;

  this.interface_data.rack_width = Math.floor(view_width / rack_space_sz);
  this.interface_data.rack_width_per = (rack_space_sz / view_width) * 100;
  this.interface_data.rack_height = Math.floor(view_height / rack_space_sz);
  this.interface_data.rack_height_per = (rack_space_sz / view_height) * 100;

  kr.debug("rw: " + this.interface_data.rack_width + "rh: " + this.interface_data.rack_height);
  kr.debug("rwp: " + this.interface_data.rack_width_per + "rhp: " + this.interface_data.rack_height_per);
...
Kr.prototype.first_open_rack_position = function(RCU, positioned_RCUs) {
  var ret = null;
  var fits = 1;
  for (var j = 0; j < kr.interface_data.rack_height; j++) {
    for (var i = 0; i < kr.interface_data.rack_width; i++) {
      for (var r = 0; r < positioned_RCUs.length; r++) {
       if (
           ...
           ||
            ...
            && (j + RCU.height>= positioned_RCUs[r].y && positioned_RCUs[r].y + positioned_RCUs[r].height > j+RCU.height))
            ||
             (i+RCU.width > kr.interface_data.rack_width || j + RCU.height > kr.interface_data.rack_height)
           ) {
...
Kr.prototype.position_RCUs = function() {
  ...
  for (var i = 0; i < kr.interface_data.RCUs.length; i++) {
        ...
        var top = kr.interface_data.rack_height_per * kr.interface_data.RCUs[i].y;
        var left = kr.interface_data.rack_width_per * kr.interface_data.RCUs[i].x;
        var height = kr.interface_data.rack_height_per * kr.interface_data.RCUs[i].height;
        var width = kr.interface_data.rack_width_per * kr.interface_data.RCUs[i].width;
