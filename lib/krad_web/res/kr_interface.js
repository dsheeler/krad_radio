...
<div id='stack'><button class='close'>&times;</button>\
<div class='chooser'>\
...
//	  $('#portgroup_' + portgroup_name + '_wrap').after("<div id='portgroup_"
    $('#mixers').append("<div id='portgroup_"
     ...
     + "class='kradmixer_control crossfade_control'> <h6>" + portgroup_name
     + " - " + crossfade_name + "</h6><div id='"
...
Kr.prototype.got_add_portgroup = function(crate) {
  ...
  if (crate.direction == 1) {
    ...
    $('.kradmixer_cappa').append("<div class='effect_area' "
     ...
     + "_effects' style='float:left'><h4>Effects for "
     + crate.portgroup_name + "</h4></div>");
    ...
    $('.kradmixer_cappa').append(
     ...
     + "'><h4>Eq for " + crate.portgroup_name
     + "</h4></div>");
