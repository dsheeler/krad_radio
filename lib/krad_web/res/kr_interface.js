Kradradio.prototype.setsprite = function (sprite_num, x, y) {
  kradradio.ctrl("s/" + sprite_num + "/x", x);
  kradradio.ctrl("s/" + sprite_num + "/y", y);
}
...
function Shape(x, y, w, h, r, o, xs, ys, type, num, fill) {
    ...
    this.PCView = type == 'videoport' ? new PerspectiveCorrectionView(0,0,this.w,0,0,this.h,this.w, this.h) : null;
...
function CanvasState(canvas, ghostcanvas) {
    ...
    canvas.addEventListener('mousemove', function(e) {
	      if (myState.dragging){
	          ...
	          kradradio.comp_ctrl(myState.selection.num, myState.selection.type, "x", myState.selection.x);
	          kradradio.comp_ctrl(myState.selection.num, myState.selection.type, "y", myState.selection.y);
	          return;
            ...
            mx = Math.cos(myState.selection.r) * mx + Math.sin(myState.selection.r) * my;
            my = -Math.sin(myState.selection.r) * mx + Math.cos(myState.selection.r) * my;

            //myState.selection.PCView.handles[myState.expectMovePerspectiveCorrectionHandle].x = Math.cos(myState.selection.r) * tmpx - Math.sin(myState.selection.r) * tmpy;
            //myState.selection.PCView.handles[myState.expectMovePerspectiveCorrectionHandle].y = Math.sin(myState.selection.r) * tmpx + Math.cos(myState.selection.r) * tmpy;
            
            //var selx = Math.cos(myState.selection.r) * myState.selection.x - Math.sin(myState.selection.r) * myState.selection.y;
            //var sely = Math.sin(myState.selection.r) * myState.selection.x + Math.cos(myState.selection.r) * myState.selection.y;
            myState.selection.PCView.handles[myState.expectMovePerspectiveCorrectionHandle].x =  mx/myState.selection.xs  + myState.selection.w*0.5;;
            myState.selection.PCView.handles[myState.expectMovePerspectiveCorrectionHandle].y =  my/myState.selection.ys  + myState.selection.h*0.5;;
            kradwebsocket.debug(myState.selection.PCView.handles[myState.expectMovePerspectiveCorrectionHandle].x + " " 
            ...
            return;
	          ...
	          case 0:
                ...
                if (xscale > yscale) {
		            ...
		            kradradio.comp_ctrl(myState.selection.num, myState.selection.type, "xscale", xscale);
		            kradradio.comp_ctrl(myState.selection.num, myState.selection.type, "x", x);
		            
		            myState.selection.xs = xscale;
		            myState.selection.x = x;


		            kradradio.comp_ctrl(myState.selection.num, myState.selection.type, "yscale", xscale);
		            kradradio.comp_ctrl(myState.selection.num, myState.selection.type, "y", y);
	          ...
	          case 1:
		            ...
		            kradradio.comp_ctrl(myState.selection.num, myState.selection.type, "yscale", ys);
		            kradradio.comp_ctrl(myState.selection.num, myState.selection.type, "y", my);
	          ...
	          case 3:
		            ...
		            kradradio.comp_ctrl(myState.selection.num, myState.selection.type, "xscale", xs);
		            kradradio.comp_ctrl(myState.selection.num, myState.selection.type, "x", mx);
	          ...
	          case 4:
		            kradradio.comp_ctrl(myState.selection.num, myState.selection.type, "xscale", (mx - oldx) / myState.selection.w);
	          ...
	          case 6:
		            kradradio.comp_ctrl(myState.selection.num, myState.selection.type, "yscale", (my - oldy) / myState.selection.h);
	          ...
	          case 8:
		            ...
		            kradradio.comp_ctrl(myState.selection.num, myState.selection.type, "rotation", angle *180/Math.PI);
		            break;

	          case 9:
		            myState.selection.o = -0.5+2*(myState.height-mouse.y)/myState.height;
                kradradio.comp_ctrl(myState.selection.num, myState.selection.type, "opacity", myState.selection.o);
...
<div id='" + crate.portgroup_name + "'></div><h2>" + crate.portgroup_name + "</h2></div>";
    ...
    if (crate.portgroup_name == "DTMF") {
	      ...
	      $('#' + crate.portgroup_name + '_dtmf').append("<div class='button_wrap'><div class='krad_button' id='" + crate.portgroup_name + "_dtmf_4'>4</div>");
    ...
    if (crate.direction == 1) {
	      ...
	      for (var i = 0; i < 32; i++) {
	          ...
	          $( '#' + crate.portgroup_name + '_eq_' + i + '_hz' ).bind( "slide", {band: i}, function(event, ui) {
	            kradradio.ctrl("e/" + crate.portgroup_name + "/eq/" + event.data.band + "/hz", ui.value);
	          });
	      }
	      ...
	      for (var i = 0; i < 32; i++) {
	          ...
	          $( '#' + crate.portgroup_name + '_eq_' + i + '_bw' ).bind( "slide", {band: i}, function(event, ui) {
	            kradradio.ctrl("e/" + crate.portgroup_name + "/eq/" + event.data.band + "/bw", ui.value);
	          });
	      }
    }
