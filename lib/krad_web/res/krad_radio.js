...
Kradradio.prototype.portgroup_handle_crossfade_group = function (portgroup_name, crossfade_name, crossfade) {
  ...
  if (crossfade_name.length > 0) {
    $('.kradmixer').append("<div id='portgroup_" + portgroup_name + "_crossfade_wrap' class='kradmixer_control crossfade_control'> <div id='" + portgroup_name + "_crossfade'></div> <h2>" + portgroup_name + " - " + crossfade_name + "</h2></div>");
...
Kradradio.prototype.got_add_portgroup = function (portgroup_name, volume, crossfade_name, crossfade, xmms2) {
  ...
  if (xmms2 == 1) {
    xmms2_controls = "<div class='kradmixer_control xmms2_control'><div id='" + portgroup_name + "_xmms2'></div></div>";
