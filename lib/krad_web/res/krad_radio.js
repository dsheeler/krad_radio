...
Kradradio.prototype.got_sysname = function (sysname) {
  ...
  $('#kradradio').append("<div class='kradradio_station' id='" + this.sysname + "'>\
    ...
    <canvas height='200' width='42' class='meter' id='MasterBUS_meter_canvas'></canvas>\
    <h2>MasterBus</h2>\
    </div>\
    </div>\
    <br clear='both'>\
...
Kradradio.prototype.got_add_portgroup = function (crate) {
  ...
  volume_div = "<div class='kradmixer_control volume_control' id='portgroup_" + crate.portgroup_name + "_wrap'>\
                <div class='meter_wrapper'><canvas width='42' height='200' class='meter' id='" + crate.portgroup_name + "_meter_canvas'></canvas></div>\
  ...
  if (crate.direction == 1) {
    $('.kradmixer_cappa').append("<div class='kradmixer_control effect_area'> <div id='" + crate.portgroup_name + "_effects'> Effects for " + crate.portgroup_name + "</div> </div>");
    ...
    for (var i = 0; i < 32; i++) {
      ...
      $('#' + crate.portgroup_name + '_effects').append("<div class='kradmixer_control' id='" + crate.portgroup_name + "_eq_" + i + "_hz'></div>");
      $('#' + crate.portgroup_name + '_effects').append("<div class='kradmixer_control' id='" + crate.portgroup_name + "_eq_" + i + "_db'></div>");
      $('#' + crate.portgroup_name + '_effects').append("<div class='kradmixer_control' id='" + crate.portgroup_name + "_eq_" + i + "_bw'></div>");
      $('#' + crate.portgroup_name + '_eq_' + i + '_hz').slider({orientation: 'vertical', value: crate.eq.bands[i].hz, step: 1, min: 20.0, max: 20000.0 });
