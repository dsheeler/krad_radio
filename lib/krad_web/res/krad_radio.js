...
function Shape(x, y, w, h, r, o, xs, ys, type, num, fill) {
    ...
    this.PCView = new PerspectiveCorrectionView(0, 0,
                                                this.w,0,
                                                0, this.h,
                                                this.w, this.h);
...
Kradradio.prototype.got_add_subunit = function (crate) {
    ...
    var shape = new Shape(crate.x,crate.y, crate.width, crate.height, crate.r * Math.PI / 180.0, crate.o, crate.xscale, crate.yscale); // The default is gray
    shape.type = crate.subunit_type;
    shape.num = crate.subunit_id;
