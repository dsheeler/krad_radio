...
Kradradio.prototype.got_sysname = function (sysname) {
  ...
  $('#kradradio').append("<div class='kradradio_station' id='" + this.sysname + "'>\
              <canvas style='float: left; margin-top: 20px; box-shadow: 2px 2px 8px #aaa; padding: 1px;' width='42' height='160' id='master_peak_canvas'>\
            </canvas>\
...
Kradradio.prototype.got_peak_portgroup = function (portgroup_name, value) {
  ...
  //canvas = document.getElementById(portname  + '_peak_canvas');
  canvas = document.getElementById('master_peak_canvas');
