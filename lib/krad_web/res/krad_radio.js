...
//		mySel.num = 666;
	...
	if (myState.dragging){
	    ...
	    kradwebsocket.debug(myState.selection);
	    ...
	    case 9:
      		kradradio.update_subunit(myState.selection.num, myState.selection.type, "opacity", (myState.selection.h-mouse.y)/myState.selection.h);
...
Kradradio.prototype.portgroup_draw_peak_meter = function (portgroup_name, value) {
    ...
    if (this.peaks_max[portgroup_name] == 100) {
...
Kradradio.prototype.got_add_subunit = function (crate) {
	...
	$('.kradcompositor').append("<div class='kradcompositor_sprite_position_control'><canvas width='960px' height='540px' id='compositor_canvas'></canvas></div><br clear='both'><div><ul id='subunit_list'></ul></div>");
    ...
    var shape = new Shape("bug", crate.x,crate.y, crate.width, crate.height, crate.r * Math.PI / 180.0, crate.o, crate.xscale, crate.yscale); // The default is gray
