...
function CanvasState(canvas, ghostcanvas) {
    ...
    canvas.addEventListener('mousemove', function(e) {
	      if (myState.dragging){
            ...
            kradwebsocket.debug("selection " + myState.selection.PCView.handles[myState.expectMovePerspectiveCorrectionHandle].x + " " + myState.selection.PCView.handles[myState.expectMovePerspectiveCorrectionHandle].y);
            kradwebsocket.debug("mouse " + mx + " " +  my);
