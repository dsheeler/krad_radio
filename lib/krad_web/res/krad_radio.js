...
function Shape(label, x, y, w, h, r, fill) {
...
Kradradio.prototype.kradcompositor_controls = function () {
  ...
  $('.kradcompositor').append("<div class='button_wrap'><div class='krad_button_toggle' id='rotate'>Rotate Sprite</div>"); 
  $('.kradcompositor').append("<br clear='both'/>");
  
  $( '#rotate').bind( "click", function(event, ui) {
    kradradio.rotate_on = kradradio.rotate_on ? false : true;
