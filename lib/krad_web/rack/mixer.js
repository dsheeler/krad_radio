Kr.prototype.mixer_got_add_portgroup = function(crate) {
  this.ux.peaks[crate.portgroup_name] = -1;
  this.ux.peaks_max[crate.portgroup_name] = -1;
  this.ux.portgroup_count += 1;
  if (crate.xmms2 == 1) {
    this.ux.xmms2_portgroup_count += 1;
  }
  ...
  if (crate.portgroup_name == "DTMF") {
	  ...
	  $('#' + this.ux.sysname).append("<div id='dtmf_pad' "
...
Kr.prototype.mixer_got_peak_portgroup = function(portgroup_name, value) {
  ...
  if (this.ux.peaks_max[portgroup_name] < this.ux.peaks[portgroup_name]) {
    this.ux.peaks_max[portgroup_name] = this.ux.peaks[portgroup_name];
  }
  if (this.ux.peaks[portgroup_name] == value) {
    return;
  } else {
    this.ux.peaks[portgroup_name] = value;
  }
