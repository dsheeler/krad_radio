$(document).ready(function() {
  rack_units.push({'constructor': Rtc, 'aspect': [32,10], 'page': 1});
});
...
function Rtc(info_object) {
  ...
  this.div_text = "<div id='rtc' class='coolblue RCU rtc'></div>";
  this.sel = "#rtc";
  ...
  <div style='width:100%;float:left'>\
    ...
    <div style='float:left' id='add_remove_stream_buttons'>\
