...
function Comper(info_object) {
  ...
  $(this.sel).append("<canvas width='960px'"
  + "height='540px' class='yelleryellow kradcompositor_canvas'"
...
function CanvasState(canvas, ghostcanvas) {
  ...
  canvas.addEventListener('mousemove', function(e) {
      ...
      myState.selection.x = mouse.x - myState.dragoffx;
	    ...
	    comp_ctrl(myState.selection.num,
      ...
      switch (myState.expectResize) {
          ...
          comp_ctrl(myState.selection.num, myState.selection.type, "xscale", xscale);
          comp_ctrl(myState.selection.num, myState.selection.type, "x", x);

          myState.selection.xs = xscale;
          myState.selection.x = x;

          comp_ctrl(myState.selection.num, myState.selection.type, "yscale", xscale);
          comp_ctrl(myState.selection.num, myState.selection.type, "y", y);
        ...
        case 1:
           ...
           / myState.selection.h ;
	  	    comp_ctrl(myState.selection.num, myState.selection.type,
           "yscale", ys);
          comp_ctrl(myState.selection.num, myState.selection.type,
           "y", my);
