...
int krad_sprite_to_rep (krad_sprite_t *sprite, krad_sprite_rep_t *sprite_rep) {
  ...
  sprite_rep->controls.x = sprite->krad_compositor_subunit.x;
  sprite_rep->controls.y = sprite->krad_compositor_subunit.y;
  sprite_rep->controls.z = sprite->krad_compositor_subunit.z;
  
  sprite_rep->controls.tickrate = sprite->krad_compositor_subunit.tickrate;

  sprite_rep->controls.width = sprite->krad_compositor_subunit.width;
  sprite_rep->controls.height = sprite->krad_compositor_subunit.height;
    
  sprite_rep->controls.xscale = sprite->krad_compositor_subunit.xscale;
  sprite_rep->controls.yscale = sprite->krad_compositor_subunit.yscale;
    
  sprite_rep->controls.rotation = sprite->krad_compositor_subunit.rotation;
  sprite_rep->controls.opacity = sprite->krad_compositor_subunit.opacity;
