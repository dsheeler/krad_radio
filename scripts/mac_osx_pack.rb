...
krad_dep_libs += ["libx264.128.dylib", "libtheora.0.dylib", "libogg.0.dylib", "libtheoraenc.1.dylib"]
krad_dep_libs += ["libtheoradec.1.dylib", "libvorbis.0.dylib", "libvorbisenc.2.dylib", "libopus.0.dylib"]
krad_dep_libs += ["libFLAC.8.dylib", "libswscale.2.dylib", "libavutil.52.dylib"]
...
for file in krad_binaries
  ...
  `install_name_tool -change /Users/oneman/kode/krad_radio/.waf_build_directory/clients/libkradradio_client.15.dylib @executable_path/libkradradio_client.15.dylib #{krad_appfolder_exec_path}#{file}`
end
...
`rm /Users/oneman/kode/Krad\\ Radio\\ 15\\ Mac.tar.bz2`
`tar cjvf /Users/oneman/kode/Krad\\ Radio\\ 15\\ Mac.tar.bz2 -C /Users/oneman/kode Krad\\ Radio.app`
